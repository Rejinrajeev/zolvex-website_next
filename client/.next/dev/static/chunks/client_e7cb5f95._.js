...
"[project]/client/src/app/admin/users/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminUsersPage() {
    ...
    const [users, setUsers] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t0);
    const [, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    ...
    if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
        t3 = ({
            "AdminUsersPage[toggleUserActive]": (id)=>{
                setUsers({
                    "AdminUsersPage[toggleUserActive > setUsers()]": (prev)=>prev.map({
                            "AdminUsersPage[toggleUserActive > setUsers() > prev.map()]": (u)=>u._id === id ? {
                                    ...u,
                                    isActive: !u.isActive
                                } : u
                        }["AdminUsersPage[toggleUserActive > setUsers() > prev.map()]"])
                }["AdminUsersPage[toggleUserActive > setUsers()]"]);
            }
        })["AdminUsersPage[toggleUserActive]"];
        $[4] = t3;
    } else {
        t3 = $[4];
    }
    const toggleUserActive = t3;
    let t4;
    if ($[5] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = ({
            "AdminUsersPage[changeRole]": (id_0, newRole)=>{
                setUsers({
                    "AdminUsersPage[changeRole > setUsers()]": (prev_0)=>prev_0.map({
                            "AdminUsersPage[changeRole > setUsers() > prev_0.map()]": (u_0)=>u_0._id === id_0 ? {
                                    ...u_0,
                                    role: newRole
                                } : u_0
                        }["AdminUsersPage[changeRole > setUsers() > prev_0.map()]"])
                }["AdminUsersPage[changeRole > setUsers()]"]);
            }
        })["AdminUsersPage[changeRole]"];
        $[5] = t4;
    } else {
        t4 = $[5];
    }
    ...
    if ($[6] !== search || $[7] !== users) {
        ...
        if ($[19] !== search) {
            t16 = ({
                "AdminUsersPage[users.filter()]": (u_1)=>u_1.fullName.toLowerCase().includes(search.toLowerCase()) || u_1.email.toLowerCase().includes(search.toLowerCase()) || u_1.phone.includes(search)
            })["AdminUsersPage[users.filter()]"];
            $[19] = search;
            $[20] = t16;
        } else {
            t16 = $[20];
        ...
        if ($[24] === Symbol.for("react.memo_cache_sentinel")) {
            t18 = ({
                "AdminUsersPage[<input>.onChange]": (e)=>setSearch(e.target.value)
    ...
    let t16;
    if ($[29] !== t5 || $[30] !== t6) {
        t16 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
            className: t5,
            children: t6
        }, void 0, false, {
            fileName: "[project]/client/src/app/admin/users/page.tsx",
    ...
    let t17;
    if ($[32] !== t16 || $[33] !== t7 || $[34] !== t8) {
        t17 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
            className: t7,
            children: [
                t8,
                t16
    ...
    let t20;
    if ($[42] !== t11 || $[43] !== t12 || $[44] !== t13 || $[45] !== t19) {
        t20 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
            className: t11,
            children: [
                t12,
                t13,
...
_s(AdminUsersPage, "EvV05Mpe/rdOPDedJoJcbfAIXvQ=");
_c = AdminUsersPage;
var _c;
...
//# sourceMappingURL=client_e7cb5f95._.js.map