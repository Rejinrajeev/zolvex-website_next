...
function AdminBookingsPage() {
    ...
    const fetchBookings = async ()=>{
        ...
        try {
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWithAuth"])(url);
    ...
    const handleStatusChange = async (id, newStatus)=>{
        setUpdatingId(id);
        try {
            const res_0 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWithAuth"])(`/api/v1/admin/bookings/${id}/status`, {
                method: "PATCH",
                body: JSON.stringify({
                    status: newStatus
                })
    ...
    const handleAssignTechnician = async (e_1)=>{
        ...
        try {
            const res_1 = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$client$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchWithAuth"])(`/api/v1/admin/bookings/${assigningBooking._id}/assign`, {
                method: "POST",
...
//# sourceMappingURL=client_src_05426cae._.js.map