      ...
      <main className="flex-1 p-4 sm:p-8 overflow-y-auto">
        ...
        <div className="bg-card border border-border p-4 rounded-2xl mb-6 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-xs">
          ...
          <div className="flex items-center space-x-2 overflow-x-auto w-full sm:w-auto">
            {["all", "deep_cleaning", "water_tank", "house_cleaning", "sofa_cleaning"].map((cat) => (
              <button
                key={cat}
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map((s) => (
              <div key={s._id} className="bg-card border border-border p-5 rounded-3xl space-y-4 relative flex flex-col justify-between shadow-xs">
                <div className="space-y-3">
                  ...
                  <div>
                    <h3 className="font-extrabold text-foreground text-base">{s.name}</h3>
                  ...
                  <div className="flex items-center justify-between text-xs pt-2">
                    ...
                    <span className="text-muted font-semibold flex items-center space-x-1">
